        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2" style="padding-bottom: 2rem" >
                <nav>
                    <div></div>
                    <ul class="clearfix">
                        <div class="logo-main" style="width: 94px; position: absolute; height: 85px; top: 0; left: 355px; text-align: center"><a href="login.php" style="text-transform: uppercase; letter-spacing: 2px;" ><img src="img/main-logo.png"  >Login</a></div>
