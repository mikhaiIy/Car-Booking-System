...
<html lang="en">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2" style="padding-bottom: 2rem" >
                    <nav>
                        <div></div>
                        <ul class="clearfix">
                            <div class="logo-main" style="width: 94px; position: absolute; height: 85px; top: 0; left: 327px; text-align: center"><a href="register.php" style="text-transform: uppercase; letter-spacing: 2px;" ><img src="img/main-logo.png"  >Register</a></div>
    ...
    <section class="py-4 py-xl-5">
        <form class="form" autocomplete="off" method="post" action="loginprocess.php">
            <div class="control">
                <h1>
                    Sign In
                </h1>
