                ...
                <div class="row costumrow">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 txt1colon ">
                        <div class="featurecontant">
                            ...
                            <h2>Price &euro;</h2>
                            <button id="btnRM" onclick="">READ MORE</button>
                            <div id="readmore">
                                <h1>Car Name</h1>
                                <p>"Lorem ipsum dolor sit amet, consectetur ,<br>
    ...
    <div class="grid">
        <div class="row">
            ...
            while ($row=mysqli_fetch_array($result)){
                ...
                <button type="button" class="open-my-modal fancy-btn" data-v-reg="<?php echo $row["v_reg"]?>" data-v-type="<?php echo $row["v_type"]?>" data-v-price="<?php echo $row["v_price"]?>" data-toggle="modal" data-target="#largeShoes">BOOK</button><br>
                <?php
                echo $row["v_reg"];
